...
export default function CodeHighlighter({
  ...
  return (
    <div className={cn("group relative my-3", className)}>
      {/* Code container */}
      <div
        className="border-border scrollbar-hide relative overflow-hidden rounded-lg border bg-slate-50 dark:bg-zinc-900"
        style={{
          maxHeight:
      ...
      >
        ...
        {shouldCollapse && (
          <button
            ...
            className={cn(
              "absolute right-3 bottom-3 z-10 flex items-center gap-1.5 rounded-md",
              "border-border bg-background text-muted-foreground border px-3 py-1.5 text-xs font-medium",
