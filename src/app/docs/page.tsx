...
export const metadata = {
  ...
  description: "Get started with the Kick UI component registry.",
};
  ...
  return (
    <main className="mx-auto w-full max-w-5xl space-y-14 px-4 py-12 sm:px-6">
      ...
      <section aria-labelledby="install" className="space-y-4">
        <div>
          <h2 id="install" className="text-2xl font-semibold">Install a component</h2>
      ...
      <section aria-labelledby="principles" className="space-y-4">
        <h2 id="principles" className="text-2xl font-semibold">Library principles</h2>
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ["Accessible by default", "Semantic controls, focus styles, and labels are included in the documentation experience."],
            ["Own your code", "Registry installs place component source in your app, so every detail remains customizable."],
            ["Built for composition", "Components accept class names and focused props to fit naturally into existing systems."],
      ...
      <section aria-labelledby="categories" className="space-y-4">
        <h2 id="categories" className="text-2xl font-semibold">Explore by category</h2>
